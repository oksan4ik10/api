  ...
  createCat() {
    ...
    <div class="cat__block">
        <div class="cat__area">
            ...
            <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1920" fill="${this.color}">
                <g>
